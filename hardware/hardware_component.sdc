...
# VGA : 800x600@60Hz
#create_clock -period "40.0 MHz" -name vga_clk [get_ports VGA_CLK]
# VGA : 1024x768@60Hz
#create_clock -period "65.0 MHz" -name vga_clk [get_ports VGA_CLK]
# VGA : 1280x1024@60Hz
#create_clock -period "108.0 MHz" -name vga_clk [get_ports VGA_CLK]
create_generated_clock -divide_by 2 -source [get_ports CLOCK_50] -name vga_clk [get_registers clk_generator:gen_vga_clk|out_clk]
...
set_output_delay -max -clock vga_clk 0.220 [get_ports VGA_R*]
set_output_delay -min -clock vga_clk -1.506 [get_ports VGA_R*]
set_output_delay -max -clock vga_clk 0.212 [get_ports VGA_G*]
set_output_delay -min -clock vga_clk -1.519 [get_ports VGA_G*]
set_output_delay -max -clock vga_clk 0.264 [get_ports VGA_B*]
set_output_delay -min -clock vga_clk -1.519 [get_ports VGA_B*]
set_output_delay -max -clock vga_clk 0.215 [get_ports VGA_BLANK_N]
set_output_delay -min -clock vga_clk -1.485 [get_ports VGA_BLANK_N]
set_output_delay -max -clock vga_clk 0.215 [get_ports VGA_SYNC_N]
set_output_delay -min -clock vga_clk -1.485 [get_ports VGA_SYNC_N]
set_output_delay -max -clock vga_clk 0.215 [get_ports VGA_HS]
set_output_delay -min -clock vga_clk -1.485 [get_ports VGA_HS]
set_output_delay -max -clock vga_clk 0.215 [get_ports VGA_VS]
set_output_delay -min -clock vga_clk -1.485 [get_ports VGA_VS]
